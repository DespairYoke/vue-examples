...
export default {
  data() {
    return {
      ...
      prize_list: [
        ...
        {
          // icon: require("../assets/img/bean_five.png"), // 奖品图片
          count: 1, // 奖品数量
          name: "个葫芦娃公仔", // 奖品名称
          isPrize: 1 // 该奖项是否为奖品
        },
  ...
  methods: {
    ...
    rotating() {
      ...
      console.log(random)
      this.index = random; //指定每次旋转到的奖品下标
      var result_index = random ; // 最终要旋转到哪一块，对应prize_list的下标
      var result_angle = [9, 27, 45, 63,81,99,117,135,153,171,189,207,225,243,261,279,297,315,333,351]; //最终会旋转到下标的位置所需要的度数
      ...
      if (type == 0) {
        ...
        console.log(this.start_rotating_degree,"zzzzzz")
        // // //转动指针
    ...
    game_over() {
      ...
      console.log("gameover"+this.index)
